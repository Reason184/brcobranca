...
module Brcobranca
  module Boleto
    class Sicoob < Base # Sicoob (Bancoob)
      ...
      validates_length_of :nosso_numero, maximum: 7, message: 'deve ser menor ou igual a 7 dígitos.', unless: Proc.new { |a| a.valida_digito_verificador }
      validates_length_of :nosso_numero, maximum: 8, message: 'deve ser menor ou igual a 8 dígitos.', unless: Proc.new { |a| !a.valida_digito_verificador }
